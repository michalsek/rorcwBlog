...
describe "Posts" do 
 ...
 #  it "should not add post without title, content" do
 #    visit new_post_path
 ...
 #    expect(page).to have_content "Podaj tytuł"
    
 #    fill_in :post_title, with: "To jest chwytliwy tytuł"
 #    expect{
 #      click_on "Zapisz"
 #    }.to_not change{ Post.count }
 #    expect(page).to have_content "Podaj treść"
    
 #    fill_in :post_content, with: "test"
 #    expect{
 #      click_on "Zapisz"
 #    }.to_not change{ Post.count }
 #    expect(page).to have_content "Treść musi mieć minimum 5 znaków"
    
 #    fill_in :post_content, with: "To jest odpowiednio długa treść"
 #    expect{
 #      click_on "Zapisz"
 ...
 #  end
  ...
  # it "should not add post without category" do
  #   category1 = FactoryGirl.create :category
  #   category2 = FactoryGirl.create :category
  #   visit new_post_path
  #   fill_in :post_title, with: "Title"
  #   fill_in :post_content, with: "To jest tresc, dluga i monotonna tresc"

  #   expect{
  #     click_on "Zapisz"
  #   }.to_not change { Post.count }
  #   expect(page).to have_content "Wybierz przynajmniej jedną kategorię"

  #   select category1.name, from: :post_category_ids
  #   click_on "Zapisz"
  #   expect(current_path).to eq post_path(Post.last)
  ...
  it "should not add post with no categories" do
    ...
    expect{
      ...
      expect(page).to have_content "Podaj kategorię"
